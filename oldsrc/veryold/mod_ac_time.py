...
conv_m = (D**2)*np.array([0,1,0,1,-4,1,0,1,0]).reshape(3,3)
...
# Loop das diferenças finitas: 
    ...
    Pf[1:Nz-1,1:Nx-1] =C2[1:Nz-1,1:Nx-1] * (Pc[2:Nz,1:Nx-1] - 2 * Pc[1:Nz-1,1:Nx-1] + Pc[0:Nz-2,1:Nx-1] + Pc[1:Nz-1,2:Nx] - 2 * Pc[1:Nz-1,1:Nx-1] + Pc[1:Nz-1,0:Nx-2]) + 2 * Pc[1:Nz-1,1:Nx-1] - Pp[1:Nz-1,1:Nx-1]
...
#    Pf =  C2 * signal.convolve2d(Pc,conv_m,mode="same") + 2*Pc - Pp
